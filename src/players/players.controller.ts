...
import { ValidationsParametersPipe } from '../common/pipes/validations-parameters.pipe';
...
export class PlayersController {
  ...
  @Put('/:_id')
  @UsePipes(ValidationPipe)
  async update(@Param('_id', ValidationsParametersPipe) id: string, @Body() updatePlayerDto: UpdatePlayerDto) {
  ...
  @Delete('/:_id')
  async remove(@Param('_id', ValidationsParametersPipe) id: string) {
